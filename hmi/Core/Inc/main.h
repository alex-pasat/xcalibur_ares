...
#define DOWN_BTTN_Pin GPIO_PIN_13
#define DOWN_BTTN_GPIO_Port GPIOB
#define UP_BTTN_Pin GPIO_PIN_14
#define UP_BTTN_GPIO_Port GPIOB
#define LEFT_BTTN_Pin GPIO_PIN_15
#define LEFT_BTTN_GPIO_Port GPIOB
#define RIGHT_BTTN_Pin GPIO_PIN_8
#define RIGHT_BTTN_GPIO_Port GPIOD
